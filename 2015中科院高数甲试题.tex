...
\noindent二.计算$\underset{n\rightarrow\infty}{\lim}\frac{1}{n}\left(\sqrt{1+\sin\frac{\pi}{n}}+\sqrt{1+\sin\frac{2\pi}{n}}+\text{……}+\sqrt{1+\sin\frac{n\pi}{n}}\right)$.

\noindent三.设$u=e^{x^{2}}\sin\frac{x}{y}$，计算$\frac{\partial^{2}u}{\partial x\partial y}$在点$\left(\pi,2\right)$处的值.
